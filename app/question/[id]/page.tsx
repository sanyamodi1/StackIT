...
import { getQuestionById } from '@/lib/prisma/questions';

export default function QuestionDetail() {
    const { id } = useParams();
    const [question, setQuestion] = useState<{ title: string; description: string; answers: string[] } | null>(null);
    ...
    return (
        <div className="bg-background text-white min-h-screen py-10 px-4">
            {/* ── Question Box ── */}
